  ...
  "form": [
    ...
    { "type": "fieldset",
      ...
      "items": [
		...
		var res = encode64(deflate(unescape(encodeURIComponent(value))));
		if (res != 'AyrBIKtBp4jD0G00') {
		  // alert(value + "\n" + res);
		  $("img[id='model.plantUML.res']").attr('src',"http://www.plantuml.com/plantuml/png/"+res);
		}
	      }
	    },
            { "key": "model.freeText",
